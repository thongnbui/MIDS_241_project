...
* Instead of using in-person experiment which may have issue with insufficient wash-out period, we might utilize 2 separate groups for treatment and control to avoid this issue.
* Possibly implement more advanced blocking and clustering methods to account for variations in relaxation placebo activities, as well as variations in meditation methods and lengths.
