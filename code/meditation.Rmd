...
e_mod = lm(med_pul_diff~B4_Med_BP_PUL+Group+experience + Age_Group + Religion + Gender, 
           data = d2)
summary(e_mod)
```
...
cat("Meditation pulse difference by Group, Experience, Age, Religion and Gender \n")
e_mod = lm(col_pul_diff~B4_Med_BP_PUL+Group+experience + Age_Group + Religion + Gender, 
           data = d2)
summary(e_mod)
```
