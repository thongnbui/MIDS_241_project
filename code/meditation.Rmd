...
# On coloring systolic & group interaction
...
m4b <- lm(After_color_BP_Pul ~ pre_existing_BP + Years_practice + caffeinated_drinks + hours_since_last_caffeinated_drink + B4_color_BP_Sys + Group + B4_color_BP_Pul * Group, data=d2)

stargazer(m3, m4, m4b, type = "text")
```
# Generalization
