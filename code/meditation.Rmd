...
```{r}
# On meditation Sys on treatment group
...
#m2 <- lm(After_Med_BP_Sys ~ pre_existing_BP + Years_practice + Group + Years_practice * Group + caffeinated_drinks + hours_since_last_caffeinated_drink + B4_Med_BP_Sys , data=d2)
m1 <- lm(med_sys_diff ~ pre_existing_BP + Years_practice + Group + Years_practice * Group + caffeinated_drinks + hours_since_last_caffeinated_drink, data=d2)
#stargazer(m2, m2a, type = "text")

# On meditation pulse on treatment group
#m2b <- lm(After_Med_BP_PUL ~ pre_existing_BP + Years_practice + Group + Years_practice * Group + caffeinated_drinks + hours_since_last_caffeinated_drink + B4_Med_BP_PUL , data=d2)
#summary(m2b)
m2 <- lm(med_pul_diff ~ pre_existing_BP + Years_practice + Group + Years_practice * Group + caffeinated_drinks + hours_since_last_caffeinated_drink, data=d2)
...
m3 <- lm(col_sys_diff ~ pre_existing_BP + Years_practice + Group + Years_practice * Group + caffeinated_drinks + hours_since_last_caffeinated_drink, data=d2)

# On coloring pulse & group interaction
m4 <- lm(col_pul_diff ~ pre_existing_BP + Years_practice + Group + Years_practice * Group + caffeinated_drinks + hours_since_last_caffeinated_drink, data=d2)
